...
Создайте главный файл документации:
- Для Windows: `type nul > docs/index.md`.
- Для Mac/Linux**: `touch docs/index.md`.
...
Частые ошибки при работе с репозиторием. Подробнее читайте на странице [Чеклист](checklist.md).

## Чеклист "Все ли сделали"

Чеклист для самопроверки. Перейдите на страницу [Чеклист](checklist.md).